...
const featureCard =
  "p-12 px-9 rounded-3xl bg-bg-surface border border-black/5 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.02),0_2px_4px_-1px_rgba(0,0,0,0.01)] transition-[transform,box-shadow] duration-[250ms] ease-in-out text-left hover:-translate-y-2 hover:shadow-[0_24px_48px_-14px_rgba(0,0,0,0.12)]";

const stepCard =
  "bg-white p-11 px-9 rounded-[20px] border border-border-soft text-center transition-[transform,box-shadow] duration-[250ms] hover:-translate-y-1.5 hover:shadow-[0_20px_40px_-12px_rgba(0,0,0,0.12)]";

const stepNumber =
  "w-12 h-12 bg-brand-primary text-white rounded-full flex items-center justify-center font-bold mx-auto mb-7 text-[0.95rem] shadow-[0_0_0_10px_rgba(4,56,115,0.12)]";

const useCaseItem =
  "p-10 px-9 rounded-[18px] border border-border-soft bg-bg-surface transition-[transform,box-shadow] duration-[250ms] text-left hover:-translate-y-1 hover:shadow-[0_18px_36px_-14px_rgba(0,0,0,0.1)]";

const Landing = () => {
  return (
    <main className="w-full overflow-x-hidden">
      {/* ================= HERO ================= */}
      <section className="px-6 py-28 bg-gradient-to-b from-brand-primary to-[#071a33] text-white text-center">
        <div className="max-w-[900px] mx-auto">
          ...
          >
            ...
            <h1 className="text-[3.25rem] font-extrabold mb-5">
              Create images and rewrite content <br />
              <span>faster with AI</span>
            </h1>
            <p className="text-[1.15rem] text-[#cbd5e1] mb-10">
      ...
      {/* ================= SOCIAL PROOF ================= */}
      <section className="bg-bg-soft px-6 py-[4.5rem] border-t border-b border-black/5">
        <p className="text-xs font-bold text-brand-primary uppercase tracking-[0.15em] mb-12 text-center opacity-85">
          Trusted by professionals building with AI
        </p>

        <div
          className="max-w-[1000px] mx-auto grid gap-12 text-center grid-cols-2 md:grid-cols-4"
          {...fadeIn({
            direction: "up",
            distance: 80,
            duration: 0.9,
        ...
        >
          <div>
            <strong className="text-[2.5rem] font-extrabold text-text-primary block mb-2">
              10k+
            </strong>
      ...
      >
        <h2 className="text-center text-[2.5rem] font-extrabold tracking-[-0.02em] mb-8 text-text-primary">
      ...
      {/* ================= HOW IT WORKS ================= */}
      <section
        className="bg-[#f8fafc] px-6 py-24"
        {...fadeIn({
          direction: "right",
          distance: 80,
          duration: 0.9,
      ...
      >
        <div className="max-w-[1100px] mx-auto text-center">
          <h2
            className="text-[3rem] text-text-secondary mb-[70px]"
            {...fadeIn({
              direction: "up",
              distance: 80,
              duration: 0.9,
      ...
      {/* ================= CTA ================= */}
      <section className="bg-brand-primary px-6 py-28 text-center text-white">
        <div
          {...fadeIn({
            direction: "left",
            distance: 80,
        ...
        >
          {" "}
          <h2 className="text-[2.75rem] font-extrabold mb-4">
            Build faster with AI-powered tools
          </h2>
          <p className="text-[1.2rem] text-white/85 mb-11">
